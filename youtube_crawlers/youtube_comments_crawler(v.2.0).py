...
path = '/Users/sollee/Desktop/mulcam_army/youtube_dataset/views,likes,dislikes,ids'
filename = '/youtube_2PM.csv'

data = pd.read_csv(path + filename)
ids_list = data.iloc[:, 6]
...
for youtube_id in ids_list:
    ...
    def ajax_request(session, endpoint, ytcfg, retries=5, time=20):
...
# csv 파일 생성:
with open(f'comments_{filename}.csv', "w") as file1:
