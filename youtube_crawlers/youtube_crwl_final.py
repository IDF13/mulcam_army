...
Original file is located at
    https://colab.research.google.com/drive/1nU9RidkeFXKijZNq37EF4AnqqJmKbHBl
"""
...
path = '/content/drive/MyDrive/Colab Notebooks/[공유] Mulcam_Army 공유폴더!/크롤링 한 자료/k-pop_Radar아티스트 크롤링 할당분/성근님(14-23)/'
filename = 'stats_page_2031STAYC.csv'
...
for youtube_id in ids_list:
    ...
    # csv 파일 생성:
    with open(f'/content/drive/MyDrive/Colab Notebooks/[공유] Mulcam_Army 공유폴더!/크롤링 한 자료/k-pop_Radar아티스트 크롤링 할당분/성근_결과물/'+filename, "a", encoding='utf-8') as file1:
