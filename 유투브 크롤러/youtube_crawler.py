...
Original file is located at
    https://colab.research.google.com/drive/1CewaGX5o1op2rL6I0kGUlbn5GFs9OzaR
"""
...
path = ''  # path 변경 
filename = 'stats_page_640세븐틴.csv' # path + csv 파일명으로 크롤링 

data = pd.read_csv(path + filename)
data_list = data.sort_values("ranking")
data_list = data_list[:8] # 7위까지 크롤링
...
for youtube_id in ids_list:
    ...
    # csv 파일 생성:
    artist='Seventeen'
    with open(f'path')/comments_{artist}.csv', "a", encoding='utf-8') as f:
